...
class AudiationStationConnector {
    constructor() {
        this.sharedData = {
            recordings: [],
            detectedNotes: [],
...
// Initialize the connector when DOM is loaded
document.addEventListener('DOMContentLoaded', () => {
    window.audiationConnector = new AudiationStationConnector();
});

// Export for use in other modules
if (typeof module !== 'undefined' && module.exports) {
    module.exports = AudiationStationConnector;
}
